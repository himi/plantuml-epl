...
public class CommandLinkElement extends SingleLineCommand2<StateDiagram> {
	...
	private IEntity getFoo1(StateDiagram diagram, Code code, Ident ident, Ident pure) {
	...
	private IEntity getOrCreateLeaf1972(StateDiagram diagram, Ident ident, Code code, LeafType type, USymbol symbol,
			Ident pure) {
		if (diagram.V1972()) {
