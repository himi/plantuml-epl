...
public class CommandSysML2End extends SingleLineCommand2<SysML2Diagram> {
	public CommandSysML2End() {
	...
	protected CommandExecutionResult executeArg(SysML2Diagram diagram, LineLocation location, RegexResult arg) {
		...
		if (currentPackage == null) {
			return CommandExecutionResult.error("No SysML2 group defined");
		}
		diagram.endGroup();
